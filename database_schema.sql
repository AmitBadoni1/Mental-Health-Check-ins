...
CREATE TABLE IF NOT EXISTS checkins_data (
  ...
  checkin_number INTEGER NOT NULL,
  survey1 SMALLINT NULL,
  survey2a SMALLINT NULL,
  survey2b SMALLINT NULL,
  survey3 SMALLINT NULL,
  audio_task1_baseline TEXT NULL,
  audio_task2_stroop TEXT NULL,
  audio_task3_deadline TEXT NULL,
  audio_task4_reading TEXT NULL,
